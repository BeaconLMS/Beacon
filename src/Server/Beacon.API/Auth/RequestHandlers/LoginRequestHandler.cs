...
internal class LoginRequestHandler : IApiRequestHandler<LoginRequest, AuthUserDto>
{
    ...
    public async Task<ErrorOr<AuthUserDto>> Handle(LoginRequest request, CancellationToken ct)
    {
